...
Para analizar el comportamiento estadístico de la ruleta, se realizaron simulaciones variando el número de \textbf{corridas} (\texttt{-c}) en 1, 5 y 10. En cada caso se evaluaron las siguientes métricas estadísticas acumuladas a lo largo del número de tiradas (\texttt{-n}) 300 y 10000, con el número elegido (\texttt{-e}) 17 y 7 respectivamente:
...
A continuación, se presentan los gráficos generados para cada métrica agrupados según la cantidad de corridas y el número de tiradas. 
...
\subsection*{Histogramas de resultados obtenidos}
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
  ...
  \end{tabular}
  \caption{Histogramas de los resultados obtenidos en las simulaciones con una corrida.}
\end{figure}
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}

...
\section{Desarrollo}
Se desarrolló un script en Python 3.13.3 que simula el giro de una ruleta europea (números del 0 al 36), gestiona distintos tipos de apuestas y utiliza las siguientes librerias:
\begin{itemize}
  ...
  \item \texttt{matplotlib.pyplot}: crea y guarda gráficos de flujo de caja y frecuencia de victorias.
\end{itemize}

La simulación consta de:
\begin{enumerate}
  \item \textbf{Lectura de parámetros:} número de corridas (\texttt{-c}), tiradas (\texttt{-n}), numero especifico de la ruleta (\texttt{-e}), estrategia (\texttt{-s}), tipo de capital (\texttt{-a}), apuesta inicial (\texttt{-p}), además el usuario puede seleccionar el tipo de apuesta (\texttt{número, color, docena})
  
   \item \textbf{Para cada corrida se muestra:} 
    \begin{itemize}
      \item \textbf {Capital finito:}
    \begin{itemize}
        \item La corrida finaliza cuando el capital llega a 0 (quiebra) o cuando se alcanza el máximo de tiradas configuradas. Las quiebras son registradas para el análisis estadístico posterior.
    \end{itemize}
    \item \textbf {Capital infinito:}
    \begin{itemize}
        \item La corrida termina solo cuando se alcanza el máximo de tiradas (-n), ya que no hay quiebra.
    \end{itemize}
\end{itemize}
    \item \textbf{Resultados mostrados:} 
        \begin{itemize}
          \item {Saldo promedio final entre todas las corridas}
          \item {Cantidad de quiebras ocurridas}
          \item {Gráfico de frecuencia relativa de apuestas favorables}
          \item {Gráfico de evolución de capital promedio en función de las tiradas, incluyendo marcas donde ocurrieron quiebras}

\end{itemize}
\end{itemize}

\section{Resultados y Análisis}
Para cada estrategia se realizaron múltiples ejecuciones, con 100 tiradas cada una, alternando la cantidad de corridas entre 2 y 20, usando capital infinito y finito de \$1000 y \$10000. Mostrando la frecuencia relativa de aciertos, la evolución del capital promedio y los momentos de bancarrota (si hubo).
...
\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen.png} &
  \end{tabular}
  \caption{Martingala Capital Infinito}
\end{figure}

\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Martingala 100 tiradas 2 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Martingala 100 tiradas 20 corridas 1000 unidades monetarias}
\end{figure}

\begin{figure}[H]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen3.png} &
  \end{tabular}
  \caption{Martingala 100 tiradas 20 corridas 10000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen.png} &
  \end{tabular}
  \caption{D'Alembert Capital Infinito}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{D'Alembert 100 tiradas 2 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen3.png} &
  \end{tabular}
  \caption{D'Alembert 100 tiradas 20 corridas 10000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen.png} &
  \end{tabular}
  \caption{Fibonacci Capital Infinito}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Fibonacci 100 tiradas 2 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Fibonacci 100 tiradas 20 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen3.png} &
  \end{tabular}
  \caption{Fibonacci 100 tiradas 20 corridas 10000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen.png} &
  \end{tabular}
  \caption{Paroli Capital Infinito}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Paroli 100 tiradas 2 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen2.png} &
  \end{tabular}
  \caption{Paroli 100 tiradas 20 corridas 1000 unidades monetarias}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{insertarImagen3.png} &
  \end{tabular}
  \caption{Paroli 100 tiradas 20 corridas 10000 unidades monetarias}
\end{figure}
...
\begin{itemize}
  ...
  \item Pokerstars, “Paroli”, \url{https://www.pokerstars.es/casino/news/los-grandes-sistemas-de-la-ruleta-el-sistema-paroli/}
\end{itemize}
